...
import { ApiResponse, PaginatedResponse, ApiError } from '@secret-santa/shared-types'
...
export class ResponseHelper {
   ...
   */
  static error(res: Response, error: string, statusCode: number = 400, message?: string): void {
